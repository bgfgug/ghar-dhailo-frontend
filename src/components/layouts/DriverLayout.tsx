...
import { 
  LayoutDashboard, ShoppingBag, DollarSign, UserCircle,
...
const DriverLayout: React.FC<DriverLayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { icon: ShoppingBag, label: 'Orders', path: '/driver/orders' },
    { icon: DollarSign, label: 'Earnings', path: '/driver/earnings' },
    { icon: UserCircle, label: 'Profile', path: '/driver/profile' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b">
          <h1 className="text-xl font-bold text-secondary">Driver Panel</h1>
          <Button 
            variant="ghost" 
            size="icon" 
