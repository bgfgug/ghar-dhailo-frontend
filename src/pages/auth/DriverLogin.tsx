  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-secondary">Driver Login</CardTitle>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col gap-4">
            <Button 
              ...
              disabled={isLoading}
              aria-label="Login to driver portal"
            >
              {isLoading ? (
                <>
            ...
            <div className="text-sm text-center">
              <Link to="/auth/login" className="text-muted-foreground hover:text-secondary">
